...
export const GITHUB_CONFIG = {
	OWNER: process.env.NEXT_PUBLIC_GITHUB_OWNER || 'KomaLin1984',
	REPO: process.env.NEXT_PUBLIC_GITHUB_REPO || '2025-blog-80oldcar',
	BRANCH: process.env.NEXT_PUBLIC_GITHUB_BRANCH || 'main',
	APP_ID: process.env.NEXT_PUBLIC_GITHUB_APP_ID || '3051648',
} as const
